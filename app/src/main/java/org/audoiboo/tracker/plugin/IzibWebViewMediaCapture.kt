        ...
        Handler(Looper.getMainLooper()).post {
            ...
            webView.webViewClient = object : WebViewClient() {
                ...
                override fun onPageFinished(view: WebView, url: String) {
                    ...
                    // The PDA/desktop pages may pull unrelated media while bootstrapping. Start
                    // collecting only after the page is complete and our player hooks are installed.
                    handler.postDelayed({
                        if (!finished.get()) {
                            synchronized(found) {
                                found.clear()
                    ...
                    listOf(2_500L, 5_000L, 8_000L, 12_000L).forEach { delay ->
